...
if(isset($_GET['detailid'])){
    ...
    $sql = "SELECT * FROM ad WHERE ad_id = '$detail'";
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        echo '<div class="col-lg-12 col-md-12 col-sm-12 col-12 my-3 inP2">
        <div class="card rounded wop" style="margin: auto; cursor: pointer;">
            <img src="../images/'; echo $row['ad_image'];  echo '" class="card-img-top" alt="...">
            <div class="card-body">
                <div class="row">
