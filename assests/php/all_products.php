    ...
    <main>
        <div class="container">
            <div class="recommendation">
                <div class="row">
                    <div class="col-12">
                        <h3 class="fw-normal py-1">All Products</h3>
                    </div>
                </div>
                <div class="row inp1">
                    <?php
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<div class="col-lg-3 col-md-4 col-sm-6 col-6 my-3 inP2">
                                <div class="card rounded" style="width: 100%; cursor: pointer;" ><a href="_detail.php?detailid=' . $row['ad_id'] . '">
                                    <img style="max-height: 200px" src="../images/';
                                                echo $row['ad_image'];
                                                echo '" class="card-img-top" alt="..."></a>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-10 col-10 inP0">
                                            <a href="_detail.php?detailid=' . $row['ad_id'] . '">
                                            <h4>' . $title . '</h4>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <nav class="navbar justify-content-center">
            ...
            <ul class="nav flex-column pt-3">
                ...
                <?php
                if (isset($_SESSION['loggedin'])) {
                    echo '<li><a class="dropdown-item" href="_uploadAd.php">Sell Products</a></li>
                <li><a class="dropdown-item" href="_logout.php">Logout</a></li>';
                }
                if (isset($_SESSION['admin'])) {
                    echo '<li><a class="dropdown-item" href="_admin.php">Approve Users</a></li>';
                }
                ?>
                <hr>
                ...
                while ($categoryRow = mysqli_fetch_assoc($categoryResult)) {
                    ...
                    echo '
                                                <li><a class="dropdown-item" href="_category.php?category=' . $categoryRow['category_id'] . '">' . $categoryRow['category_name'] . '</a></li>';
                }
                ?>
